        ...
        <Grid className="landing-grid">
          <Cell col={12}>
            ...
            <div className="banner-text">
              <h1> FINAL YEAR STUDENT(CSE)</h1>

            <hr/>

          <p>HTML/CSS | Bootstrap | JavaScript | React | Python | SQL</p>

        <div className="social-links">

          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/shrimanju-k-s-9baaaa12a/" rel="noopener noreferrer" target="_blank">
            <i className="fa fa-linkedin-square" aria-hidden="true" />
          </a>

          {/* Github */}
          <a href="https://github.com/Shrimanju" rel="noopener noreferrer" target="_blank">
            <i className="fa fa-github-square" aria-hidden="true" />
          </a>

          {/* Instagram */}
          <a href="https://www.instagram.com/?hl=en" rel="noopener noreferrer" target="_blank">
            <i className="fa fa-instagram" aria-hidden="true" />
          </a>

          {/* hackerrank*/}
          <a href="https://www.hackerrank.com/products" rel="noopener noreferrer" target="_blank">
           <i className="fa fa-hackerrank" aria-hidden="true" />
          </a>
