          ...
          <Cell col={6}>
            ...
            <img
              ...
              className="avatar-imgg"
               />
             <p style={{ width: '75%', margin: 'auto', paddingTop: '1em'}}> To work in a creative environment and effectively contribute towards the goals of the organization, besides gaining as much knowledge as possible in order to achieve expertise in the working domain.
